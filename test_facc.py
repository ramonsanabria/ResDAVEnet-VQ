...
ref_segments = parse_file("/disk/scratch1/ramons/image_seg/data/facc/flickr_8k.seg")
...
# load data
hdf5_path = '/disk/scratch1/ramons/image_seg/ResDAVEnet-VQ/data/facc_dev.json'
...
with open("./facc_dev_word_20ms","w") as output_results:
    ...
    for model in models:
        ...
        if(layer_ids == ""):
            ...
            for layer_id in layer_ids.split(","):
                ...
                precision, recall, f1, os = compute_metrics(hyp_segments, ref_segments, 0.03)
